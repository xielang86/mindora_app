...
class AgeEditViewController: UIViewController, UITextFieldDelegate {
    ...
    private let titleLabel: UILabel = {
        ...
        // Changed to age title
        label.text = L("user_profile.age")
    ...
    private func setupUI() {
        ...
        inputContainer.addSubview(ageTextField)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Consistent with NicknameEditViewController update
            ...
            // Text Field
            ageTextField.leadingAnchor.constraint(equalTo: inputContainer.leadingAnchor, constant: s(24)),
            ageTextField.topAnchor.constraint(equalTo: inputContainer.topAnchor),
            ageTextField.bottomAnchor.constraint(equalTo: inputContainer.bottomAnchor),
            ageTextField.trailingAnchor.constraint(equalTo: clearButton.leadingAnchor, constant: -10),
    ...
    private func updateClearButtonVisibility() {
        let hasText = !(ageTextField.text?.isEmpty ?? true)
