...
class PhoneEditViewController: UIViewController, UITextFieldDelegate {
    ...
    private let titleLabel: UILabel = {
        ...
        label.text = L("user_profile.phone")
    ...
    private func setupUI() {
        ...
        inputContainer.addSubview(phoneTextField)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Text Field
            phoneTextField.leadingAnchor.constraint(equalTo: inputContainer.leadingAnchor, constant: s(24)),
            phoneTextField.topAnchor.constraint(equalTo: inputContainer.topAnchor),
            phoneTextField.bottomAnchor.constraint(equalTo: inputContainer.bottomAnchor),
            phoneTextField.trailingAnchor.constraint(equalTo: clearButton.leadingAnchor, constant: -10),
    ...
    private func updateClearButtonVisibility() {
        let hasText = !(phoneTextField.text?.isEmpty ?? true)
